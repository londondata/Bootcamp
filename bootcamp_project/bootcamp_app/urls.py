...
urlpatterns =[
	...
	url(r'^game/finals2/(?P<pk>[0-9]+)$', views.finals2, name="finals2"),
	...
	url(r'^game/finals3/(?P<pk>[0-9]+)$', views.finals3, name="finals3"),
	...
	url(r'^game/finalsoutcome/(?P<pk>[0-9]+)$', views.finalsoutcome, name="finalsoutcome"),
